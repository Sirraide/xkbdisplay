...
struct XLib {
    static constexpr ulong bgcolour = 0x2D'2A2E;
    static constexpr ulong fgcolour = 0xFC'FCFA;
    static constexpr ulong grey = 0x5B'595C;

    static constexpr uint base_width = 1'400;
